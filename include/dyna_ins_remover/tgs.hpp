...
namespace travel {
    ...
    private:
        ...
        bool REFINE_MODE_ = true;
        bool VIZ_MDOE_ = false;
        
        double MAX_RANGE_ = 100.0;
        double MIN_RANGE_ = 0.0;
        double TGF_RESOLUTION_ = 8.0;

        int NUM_ITER_ = 3;
        int NUM_LRP_ = 5;
        int NUM_MIN_POINTS_ = 10;
        
        double TH_SEEDS_ = 0.5;
        double TH_DIST_ = 0.125;
        double TH_OUTLIER_ = 0.3;
        
        double TH_NORMAL_ = 0.940;
        double TH_WEIGHT_ = 200.0;
        double TH_LCC_NORMAL_SIMILARITY_ = 0.03;
        double TH_LCC_PLANAR_MODEL_DIST_ = 0.1;
        double TH_OBSTACLE_HEIGHT_ = 1.0;
    ...
    public:
        ...
        void setParams(const double max_range = 100.0, const double min_range = 0.0, const double resolution = 8.0, 
                            const int num_iter = 3, const int num_lpr = 5, const int num_min_pts = 10, const double th_seeds = 0.5, 
                            const double th_dist = 0.125, const double th_outlier = 0.3, const double th_normal = 0.940, const double th_weight = 200.0, 
                            const double th_lcc_normal_similiarity = 0.03, const double th_lcc_planar_model_dist = 0.1, const double th_obstacle = 1.0,
                            const bool refine_mode = true, const bool visualization = false) {
