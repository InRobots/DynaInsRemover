...
if __name__ == "__main__":
    ...
    # parser.add_argument('--gt', default='/home/awesome/Documents/Datasets/erasor/erasor_paper_pcds/gt/00_voxel_0_2.pcd', type=str)
    # parser.add_argument('--est', default='/home/awesome/Documents/Datasets/erasor/erasor_paper_pcds/estimate/00_ERASOR.pcd', type=str)
    parser.add_argument('--gt', default='/home/awesome/Documents/Projects/dyna_ins_remover_ws/src/DynaInsReomver/data/voxel_0_2.pcd', type=str)
    parser.add_argument('--est', default='/home/awesome/Documents/Projects/dyna_ins_remover_ws/src/DynaInsReomver/data/DynaInsRemover.pcd', type=str)
